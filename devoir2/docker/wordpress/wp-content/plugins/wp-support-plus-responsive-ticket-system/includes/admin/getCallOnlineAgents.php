...
foreach ($administrators as $administrator){
	...
	if($currentAgentSettings->skype_call_availability){
		$agentAvailable=true;
	?>
		<a href="skype:<?php echo $currentAgentSettings->skype_id;?>?call">
...
if(!$agentAvailable){
	echo "<h2>".__("Sorry, currently no agent available for call!!!",'wp-support-plus-responsive-ticket-system')."</h2>";
}
?>
